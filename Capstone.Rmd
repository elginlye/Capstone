...
Pls see full coding details in [RMD chunk "prep data"](https://github.com/elginlye/datasciencecoursera/blob/master/Capstone/Capstone.Rmd)
...
Pls see full coding details in [RMD chunk "summarize data"](https://github.com/elginlye/datasciencecoursera/blob/master/Capstone/Capstone.Rmd)
...
text(0.23, 0.78, paste0("max acc=", max_acc), col = 2)
text(0.25, 0.25, paste0("cutoff=", max_acc_cutoff), col = 3)
```
